...
namespace Lesson_42_task_1
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\n------------------- request # 1 -------------------\n");
            var firms = Firms.Select(firm => firm);

            Print(firms);


            Console.WriteLine("\n------------------- request # 2 -------------------\n");
            firms = Firms.Where(firm => firm.NAME.ToLower().Contains("food"))
                         .Select(firm => firm);
            ...
            Console.WriteLine("\n------------------- request # 3 -------------------\n");
            firms = Firms.Where(firm => firm.BUSINESS.ToLower() == "marketing")
                         .Select(firm => firm);
            ...
            Console.WriteLine("\n------------------- request # 4 -------------------\n");
            firms = Firms.Where(firm => firm.BUSINESS.ToLower() == "marketing" || firm.BUSINESS.ToLower() == "it")
                         .Select(firm => firm)
                         .OrderBy(firm => firm.BUSINESS);

            Print(firms);


            Console.WriteLine("\n------------------- request # 5 -------------------\n");
            firms = Firms.Where(firm => firm.COUNT_WORKERS > 100)
                         .Select(firm => firm)
                         .OrderByDescending(firm => firm.COUNT_WORKERS);

            Print(firms);


            Console.WriteLine("\n------------------- request # 6 -------------------\n");
            firms = Firms.Where(firm => firm.COUNT_WORKERS > 100 && firm.COUNT_WORKERS < 300)
                         .Select(firm => firm)
                         .OrderBy(firm => firm.COUNT_WORKERS);

            Print(firms);


            Console.WriteLine("\n------------------- request # 7 -------------------\n");
            firms = Firms.Where(firm => firm.ADDRESS.ToLower() == "london")
                         .Select(firm => firm);
            ...
            Console.WriteLine("\n------------------- request # 8 -------------------\n");
            firms = Firms.Where(firm => firm.DIR_SURNAME.ToLower().Contains("white"))
                         .Select(firm => firm);
            ...
            Console.WriteLine("\n------------------- request # 9 -------------------\n");
            firms = Firms.Where(firm => ((DateTime.Now - firm.DATA).Days > 730))
                         .Select(firm => firm)
                         .OrderBy(firm => firm.DATA);

            Print(firms);


            Console.WriteLine("\n------------------- request # 10 -------------------\n");
            firms = Firms.Where(firm => ((DateTime.Now - firm.DATA).Days > 123))
                         .Select(firm => firm)
                         .OrderByDescending(firm => firm.DATA);

            Print(firms);


            Console.WriteLine("\n------------------- request # 11 -------------------\n");
            firms = Firms.Where(firm => firm.DIR_SURNAME.ToLower() == "black" && firm.NAME.ToLower().Contains("white"))
                         .Select(firm => firm);
